...
> **✅ DONE (2026-09-05):** IB-004 verified complete on `main`. `04-pricing-as-gtm.md` carries a "Failure modes" table plus "Common Mistakes" (8 items); `revenue-architecture.md` carries "Common mistakes" (7 items). Depth gate: 10/10 and 9/9. Struck from active queue to stop re-dispatch.
