...
loaded** ([AiSDR](https://aisdr.com/blog/sdr-vs-ai-cost/), 2026, vendor
source), while
...
5. **Step 4:** sent to the 100 perfect-fit rows first. At 300+ sends the
   ...
   held at 98%. Roughly **3–4 meetings booked per 1,000 sends**, within
   the healthy 3–10 range. Kept the winning variant, scaled to
