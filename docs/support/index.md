...
| Signal in the queue | Goes to | Action |
|---------------------|---------|--------|
| Repeat "how do I" on a feature you sell | Product marketing | New artifact or in-product hint |
| "We just hired a team for X" | AE / CSM | Expansion conversation |
| Anger about an integration you promised | Product + sales leadership | Stop selling that promise |
...
An agent can cluster tickets by ICP, draft a monthly "voice of customer" brief for PMM and outbound, and flag accounts that mentioned a competitor. A human still decides what becomes roadmap or a sequence. Do not auto-send expansion pitches from a ticket cluster without a CSM.

## Sources

- [154] Common Room, 2024: community-led support reducing tickets 30-40% (vendor source). Source registry #154.
- [199] PeerSignal: RevOps as the thin layer across functions. Source registry #199.
- [202] Notion community/support model. Source registry #202.
- [259] Revenue Operations: buyers leaving over bad mobile experience. Source registry #259.
- [302] ZoomInfo RevOps stack: CS platforms in the same engine. Source registry #302.
- [325] Instantly, 2026: 3.43% blended cold reply. Source registry #325.
