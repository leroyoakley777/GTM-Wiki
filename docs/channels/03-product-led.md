...
**Product-led growth is the channel where the product is the salesperson.** The buyer experiences the value before they talk to a human — and, at scale, often never does. It is the right primary channel when the product is easy to try without a demo, the value is self-evident in minutes, and the ACV is low enough that a human-led sales motion would not pay for itself.

This page is the *where* of PLG — when it is the right call and how to judge free-to-paid conversion. For the deeper funnel math, see the [Funnel benchmarks](../data/funnel) and [Pricing as GTM](../data/pricing-as-gtm).
...
PLG wins when the product can carry the sales conversation. It is the wrong channel when the product is so complex it needs a human to demonstrate value.
...
The single biggest mistake in PLG is quoting "the" free-to-paid conversion rate. It varies wildly by model, and your model choice *is* your strategy.

| Trial model | Visitor → signup | Signup → paid | Paying customers / 1k visitors |
|---|---|---|---|
| **Opt-in free trial** (no credit card) | ~8.5% | **~18%** | ~15 |
| **Opt-out free trial** (credit card required) | ~2.5% | **~49%** | ~12 |
...
- [ProductLed — Product-Led Growth Benchmarks](https://productled.com/blog/product-led-growth-benchmarks) — 600+ B2B SaaS survey: 9% median free-to-paid, 12% freemium visitor conversion, PQLs ~3x.
- [ChartMogul / Userpilot — SaaS Free Trial Conversion](https://userpilot.com/blog/saas-average-conversion-rate/) — model-by-model benchmarks, 1-point ≈ 15% revenue.
- [First Page Sage / Pulseahead — Trial-to-Paid Benchmarks](https://www.pulseahead.com/blog/trial-to-paid-conversion-benchmarks-in-saas) — opt-in ~18%, opt-out ~49%, freemium ~3–9%, per-1k-visitors outcomes.

---

## Further Reading

- [Funnel Benchmarks](../data/funnel) — the stage-by-stage leakage PLG runs on.
- [Pricing as GTM](../data/pricing-as-gtm) — packaging and discounting shape free-to-paid economics.
- [Channels Bullseye](../foundations/gtm-channels-bullseye) — how to pick PLG as your one best channel.
- [Inbound](./inbound) — the content/SEO channel that feeds PLG top-of-funnel.
