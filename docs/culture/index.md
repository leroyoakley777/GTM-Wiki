...
status: active
tags: [culture, gtm, sales, enablement]
...
This page is the operator view. For the seat that owns the system, see [Heads of GTM](/docs/roles/heads-of-gtm). For the outbound desk that feels culture first, see [Outbound](/docs/channels/outbound) and [SDRs](/docs/roles/sdrs).
...
## Operating habits that hold

Write the habits into the week, not the handbook.
...
Agents copy the culture you already have. If the desk celebrates send volume, an agent will send more. If the desk requires a named signal before a row goes out, an agent can draft reasons-to-reach and a human can reject the weak ones. The [agentic outbound](/docs/agentic/agentic-outbound) split only works when the human standard is already written down.

## Sources

- [15] Belkins via Autobound, 2024 quota attainment 27-30%. Source registry #15.
- [17] Instantly, 2026: reply handling speed as a lever. Source registry #17.
- [262] Sales Acceleration Formula: coach one skill; hire coachability. Source registry #262.
- [279] 20VC: respect over being liked; attrition bands. Source registry #279.
- [317] Hey Sid: firmographics resemble, they do not prove demand. Source registry #317.
- [336] Revenue Builders, 2026: systems over dashboard theater. Source registry #336.
- [341] Salesloft 2023 benchmark: activity versus reply. Source registry #341.
