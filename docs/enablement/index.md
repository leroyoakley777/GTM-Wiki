...
status: active
tags: [enablement, sales, training, outbound, revops]
...
A working enablement function owns four artifacts and one loop.

| Artifact | Used when | Done looks like |
|----------|-----------|-----------------|
| ICP and disqualifiers | List building and discovery | One page a new SDR can apply on day 2 |
| Talk tracks and email patterns | First live conversations | Short, signal-led, inspected weekly |
| Proof pack | After interest | 3 customer stories with numbers an AE can say aloud |
...
An agent can draft first-line variants, pull the right story for an account, and flag talk tracks that have not been used in 60 days. A human still certifies what is allowed to reach a customer. See [Agentic Outbound](/docs/agentic/agentic-outbound) for the desk-level SOP.

## Sources

- [259] Revenue Operations (Diorio and Hummel), 2022: enablement as a commercial pillar. Source registry #259.
- [262] Sales Acceleration Formula: certify, coach one skill. Source registry #262.
- [299] Stage 2 Capital, 2023: specialize enablement after GTM fit. Source registry #299.
- [303] Apollo sales stack: conversation intelligence as a layer. Source registry #303.
- [304] Zylo, 2026: enablement inside the workflow. Source registry #304.
- [305] Gangly, 2026: stack layers including coaching. Source registry #305.
