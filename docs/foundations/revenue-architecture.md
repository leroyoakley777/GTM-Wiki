...
- [1] [Winning by Design](https://winningbydesign.com/resources/books/revenue-architecture/):
  Revenue Architecture by Jacco van der Kooij. The revenue factory, four
  principles, GTM motions as production lines, growth formula, and
  post-growth-at-all-costs framing (registered source #60).
- [2] [GTM Syndicate](https://www.gtm-syndicate.com/revenue-architecture):
  Revenue Architecture: the six models and growth stages in visual form
  (registered source #135); underlying data credited to Winning by Design
  and BenchSights.
- [3] [Winning by Design](https://winningbydesign.com):
  BenchSights data on cost-per-dollar-of-growth and annual growth rates,
  2021 vs 2025 (registered source #60/#135).
- [4] [Winning by Design](https://winningbydesign.com):
  Growth-earners versus growth-buyers segmentation by cost-per-dollar-of-
  growth efficiency (registered source #135).
- [5] [Winning by Design](https://winningbydesign.com):
  Analysis of 70+ public companies on GTM inefficiency and revenue
  volatility (registered source #135).
- [6] [RepVue](https://repvue.com):
  Cloud Sales Index, Q4 2024 data on quota attainment (registered source
  #92).
- [7] [ChurnZero](https://churnzero.com):
  2026 report on net revenue retention (registered source #156).
- [8] [ChartMogul](https://chartmogul.com):
  H1 2024 SaaS Retention Report on NRR and growth rates (registered source
  #57).
- [9] [DigitalApplied](https://digitalapplied.com):
  2026 report on median CAC by GTM model (registered source #6/#209).

## Further reading

- Revenue Architecture by Jacco van der Kooij (Winning by Design) is the
  foundational text for system-driven GTM. [Chapter 1
  preview](https://winningbydesign.com/resources/research/revenue-architecture-chapter-1/)
- GTM Operating System by GTM Partners is the eight-pillar framework for
  GTM strategy. [ZoomInfo: Go-to-Market Strategy guide](https://pipeline.zoominfo.com/marketing/go-to-market-strategy)
- Crossing the Chasm by Geoffrey Moore is the classic on technology
  adoption lifecycle and GTM motion selection.
- The Bowtie Model by Winning by Design is the recurring revenue funnel
  that replaces the traditional linear funnel. See
  [GTM Funnel](/docs/foundations/gtm-funnel).

## Related pages

- [What is GTM](/docs/foundations/what-is-gtm) covers definition and scope.
- [GTM Strategy Framework](/docs/foundations/gtm-strategy-framework) covers
  the strategy layer on top of the factory.
- [ICP Definition](/docs/foundations/icp-definition) covers building the
  ideal customer profile that feeds the production lines.
...
- [GTM Channels Bullseye](/docs/foundations/gtm-channels-bullseye) covers
  channel selection frameworks.
- [Agentic GTM Overview](/docs/agentic/agentic-gtm-overview) covers how AI
