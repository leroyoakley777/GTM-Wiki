...
status: active
tags: [roles, marketing, demand-gen, brand, outbound]
...
Outbound sits beside marketing. It is the channel you run while inbound compounds. Marketing should supply:

- Language the ICP already uses.
...
Agents can cluster intent, draft first versions of pages, and route high-fit inbound. Humans still own claims, brand, and the number marketing will defend in the forecast meeting. See [Agentic stack](/docs/agentic/agentic-stack).

## Sources

- [6] DigitalApplied: CAC and payback bands. Source registry #6.
- [26] Salesforce State of Sales, 2024: MQL to SQL. Source registry #26.
- [27] thedigitalbloom: MQL to SQL bottleneck. Source registry #27.
- [252] Traction: bullseye and single-channel focus. Source registry #252.
- [300] ZoomInfo GTM leader guide. Source registry #300.
- [306] Go-to-Market Alliance: shared KPI dashboards. Source registry #306.
- [309] The B2B Playbook: brand as memory. Source registry #309.
- [310] Directive Consulting: brand and CAC. Source registry #310.
- [311] BCG: B2B brand underinvestment. Source registry #311.
- [312] LinkedIn B2B Institute: 95-5. Source registry #312.
- [329] Zeliq: sub-2% reply diagnosis. Source registry #329.
