...
status: active
tags: [roles, investors, board, metrics, gtm]
last_updated: 2026-09-08
---

# Investors

Investors read GTM to judge whether a company can buy customers on purpose. Product answers "can we build it." GTM answers "can we sell it again next quarter without the founder in every room."

This page is a diligence and coaching guide. Pair it with [GTM metrics](/docs/data/gtm-metrics), [Revenue architecture](/docs/foundations/revenue-architecture), and [Outbound](/docs/channels/outbound).
...
Ask for the motion in artifacts, not adjectives:

- The list definition and 20 live reasons-to-reach.
- The sequence and the last 30 days of reply and hold rates.
...
Treat "we have AI SDRs" as a claim to inspect. Agents help when the list and the offer already work [see Agentic Outbound](/docs/agentic/agentic-outbound). They do not replace ICP.

## Sources

- [8] SalesMotion: win rates by segment. Source registry #8.
- [9] getSpike: coverage bands. Source registry #9.
- [12] Janis Zech: coverage is directional. Source registry #12.
- [15] Belkins via Autobound: quota attainment. Source registry #15.
- [17] Instantly, 2026 outbound scores. Source registry #17.
- [29] Ebsta / Pavilion: ~21% close. Source registry #29.
- [39] AiSDR SDR cost (vendor source). Source registry #39.
- [252] Traction: channel focus. Source registry #252.
- [274] Crossing the Chasm. Source registry #274.
- [300] ZoomInfo GTM leader guide. Source registry #300.
- [313] David Skok, SaaS Metrics 2.0. Source registry #313.
- [315] Bessemer Cloud Index. Source registry #315.
- [324] Masters of Scale: GTM equals product in importance. Source registry #324.
- [329] Zeliq: diagnose before scaling. Source registry #329.
- [339] GTM Benchmark Report, 2025. Source registry #339.
- [340] OpenView SaaS Metrics Report, 2024. Source registry #340.
